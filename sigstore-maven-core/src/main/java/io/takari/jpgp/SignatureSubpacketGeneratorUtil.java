...
public final class SignatureSubpacketGeneratorUtil {
  ...
  /**
   * Return a list of {@link SignatureSubpacket SignatureSubpackets} from the subpacket generator, which correspond to the given {@link io.takari.jpgp.SignatureSubpacket} type.
   *
   ...
   */
  public static <P extends SignatureSubpacket> List<P> getSubpacketsOfType(io.takari.jpgp.SignatureSubpacket type,
  ...
  /**
   * Remove all packets of the given type from the {@link PGPSignatureSubpacketGenerator PGPSignatureSubpacketGenerators} internal set.
   *
   * @param subpacketType type of subpacket to remove
   * @param subpacketGenerator subpacket generator
   */
  public static void removeAllPacketsOfType(io.takari.jpgp.SignatureSubpacket subpacketType,
  ...
  public static void setExpirationDateInSubpacketGenerator(long secondsToExpire, PGPSignatureSubpacketGenerator subpacketGenerator) {
    removeAllPacketsOfType(SignatureSubpacketTags.KEY_EXPIRE_TIME, subpacketGenerator);
    subpacketGenerator.setKeyExpirationTime(true, secondsToExpire);
  }
   ...
   */
  public static long getKeyLifetimeInSeconds(Date expirationDate, @Nonnull Date creationTime) {
  ...
  /**
   * Return true, if the subpacket generator has a {@link KeyFlags} subpacket which carries the given key flag. Returns false, if no {@link KeyFlags} subpacket is present. If there are more than one
   * instance of a {@link KeyFlags} packet present, only the last occurrence will be tested.
   *
  ...
  public static boolean hasKeyFlag(KeyFlag keyFlag, PGPSignatureSubpacketGenerator generator) {
    List<KeyFlags> keyFlagPackets = getSubpacketsOfType(io.takari.jpgp.SignatureSubpacket.keyFlags, generator);
