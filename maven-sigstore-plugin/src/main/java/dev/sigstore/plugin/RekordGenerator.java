...
public abstract class RekordGenerator implements SigstoreProcessor
{
    public static Map<String, Object> rekord( SigstoreRequest request, SigstoreResult result ) throws Exception
    {
        // {
        //   "apiVersion" : "0.0.1",
        //   "kind" : "rekord",
